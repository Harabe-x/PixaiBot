...
public class DebugToolsViewModel : BaseViewModel
{
    ...
    public DebugToolsViewModel(ICreditClaimer creditClaimer, IToastNotificationSender notificationSender, IAccountsManager accountManager,
        IConfigManager configManager, IBotStatisticsManager botStatisticsManager, ILogger logger, IProxyManager proxyManager, IAccountCreator accountCreator, 
        IDialogService dialogService, IDataValidator dataValidator, IAccountLoginChecker accountLoginChecker,IRealTimeLogWatcher logWatcher)    
    {
    ...
    {
        var creditClaimerViewModel = new CreditClaimerViewModel(_creditClaimer, _notificationSender, _accountManager , _configManager , _botStatisticsManager , _logger);
    ...
    {
        var settingsViewModel = new SettingsViewModel(_dialogService, _accountManager , _dataValidator, _accountLoginChecker, _logger, _botStatisticsManager, _configManager, _notificationSender);
    ...
    {
        var accountRegistrationViewModel = new AccountCreatorViewModel(_proxyManager, _logger, _accountManager, _notificationSender, _accountCreator, _configManager);
