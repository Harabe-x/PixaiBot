...
namespace PixaiBot.UI.ViewModel
{
    internal class AccountCreatorViewModel : BaseViewModel
    {
        ...
        public AccountCreatorViewModel(IProxyManager proxyManager, ILogger logger, IAccountsManager accountsManager, IToastNotificationSender toastNotificationSender, IAccountCreator accountCreator, IConfigManager configManager)
        {
